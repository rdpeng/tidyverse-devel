...
![fct_recode() can be used to group multiple levels into a single level and/or to rename levels](images/gslides/126.png)
...
age <- today() - mydate
age
Time difference of 11787 days

## a duration object can get this information in years
as.duration(age)
[1] "1018396800s (~32.27 years)"
```
...
![`str_sub()` output counting from end of string](images/gslides/137.png)
...
![`str_sort()` output sorts strings](images/gslides/138.png)
...
Warning in normalizePath(f2): path[1]="webshot93ab624a7a.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab624a7a.png': No such
file or directory
...
str_view(names, "M$")
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab780d04c9.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab780d04c9.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
str_view(names, "a$")
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab7188e8f6.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab7188e8f6.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
![`str_count()` strings that start with "M"](images/gslides/143.png)
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab7a4ad61f.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab7a4ad61f.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
str_view_all(names, "[^aeiou]")
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab3452778e.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab3452778e.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab3e87a50e.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab3e87a50e.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab1991a4d7.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab1991a4d7.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab535c4858.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab535c4858.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab3cfbb7a2.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab3cfbb7a2.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab736a0986.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab736a0986.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab34852336.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab34852336.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab14c2ec12.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab14c2ec12.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab114b4387.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab114b4387.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
...
PhantomJS not found. You can install it with webshot::install_phantomjs(). If it is installed, please make sure the phantomjs executable can be found via the PATH variable.
Warning in normalizePath(f2): path[1]="webshot93ab2cbd3509.png": No such file or
directory
Warning in file(con, "rb"): cannot open file 'webshot93ab2cbd3509.png': No such
file or directory
Error in file(con, "rb"): cannot open the connection
```
...
![Dataset on 120 years of Olympics history on athletes and results](images/gslides/159.png)
...
![Importing data using `read_csv()`](images/gslides/160.png)

As we learned before, we can use the package `skimr` to take a look at the data. 

![Using the skimr package to have a summary of the data](images/gslides/161.png)
...
![We have different types of variables in our data](images/gslides/162.png)
...
![There are some missing values in the data](images/gslides/163.png)
...
![There is an outlier in the Age variable](images/gslides/164.png)
...
![Histogram of the variable Age](images/gslides/165.png)
...
![Boxplot of the variable Age for male and female individuals](images/gslides/166.png)
...
![Plot of the share of female athletes over time](images/gslides/167.png)
...
![Creating a variable that shows whether the athlete has a medal or not](images/gslides/168.png)

And now, we use the following code to create the boxplot.

![Boxplot for the relationship between height and having won a medal](images/gslides/169.png)
...
![Wrangling Yelp data from JSON into tidy tabular data](images/gslides/170.png)
...
![`rvest` and `xml2` are helpful for web scraping and working with XML data](images/gslides/171.png)
